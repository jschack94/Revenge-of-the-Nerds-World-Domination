...
#     if "battle complete and match is complete and no more bosses available"
#     end_screen = "congrats"
#     elsif "battle complete and match is complete"
#         move on to the next boss 
#     elsif "battle is complete"
#         moves on to the next battle 
